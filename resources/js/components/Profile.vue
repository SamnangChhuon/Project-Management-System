                            ...
                            <div class="active tab-pane" id="settings">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="file" @change="updateProfile" id="inputEmail" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" v-model="form.password" id="password" placeholder="Passport">
