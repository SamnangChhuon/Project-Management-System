...
<template>
    <div class="content-wrapper">
        <content-header page-title="Profile" page-name="Profile"></content-header>
        <div class="content">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card card-widget widget-user">
                            ...
                            <div class="widget-user-header text-white" style="background-image: url('/img/background.jpeg');height:250px;">
                                    ...
                                    <div class="active tab-pane" id="settings">
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" v-model="form.password" id="password" placeholder="Password">
    ...
    export default {
        ...
        methods: {
            ...
            updateInfo() {
                ...
                this.form.put('/api/users/profile/')
                .then(() => {
        ...
        created() {
            this.$Progress.start();
            axios.get("/api/users/profile").then(({ data }) => (this.form.fill(data)));
            this.$Progress.finish();
        }
    }
</script>
